...
public class CharacterSelector : MonoBehaviour
{
    ...
    void HandleInputP1()
    {
        // Navigation controls for Player 1 (WASD)
        if (Input.GetKeyDown(KeyCode.D)) Move(1, ref currentIndexP1, selectorHighlightP1);
        if (Input.GetKeyDown(KeyCode.A)) Move(-1, ref currentIndexP1, selectorHighlightP1);
        if (Input.GetKeyDown(KeyCode.S)) Move(columns, ref currentIndexP1, selectorHighlightP1);
        if (Input.GetKeyDown(KeyCode.W)) Move(-columns, ref currentIndexP1, selectorHighlightP1);
    ...
    void HandleInputP2()
    {
        // Navigation controls for Player 2 (Arrow Keys)
        if (Input.GetKeyDown(KeyCode.RightArrow)) Move(1, ref currentIndexP2, selectorHighlightP2);
        if (Input.GetKeyDown(KeyCode.LeftArrow)) Move(-1, ref currentIndexP2, selectorHighlightP2);
        if (Input.GetKeyDown(KeyCode.DownArrow)) Move(columns, ref currentIndexP2, selectorHighlightP2);
        if (Input.GetKeyDown(KeyCode.UpArrow)) Move(-columns, ref currentIndexP2, selectorHighlightP2);
